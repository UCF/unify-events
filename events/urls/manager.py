...
from events.views.manager.search import FeaturedEventSelect2ListView
...
urlpatterns += [
    ...
    url(r'^featuredselect2/?$', login_required(FeaturedEventSelect2ListView.as_view()), name='events.views.manager.featured-select2'),
